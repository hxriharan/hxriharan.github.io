...
I am a MS student at Northeastern University [Khoury College of Computer Sciences](https://www.khoury.northeastern.edu/){:target="_blank"}, majoring in Robotics with a concentration in Computer Science. 

Currently, I am a Graduate Researcher in the [NeuMove Lab](https://neumove.org/){:target="_blank"} under the guidance of [Prof. Seungmoon Song](http://seungmoon.com/){:target="_blank"}, where I am working on vision-based human motion capture and neuromechanical modeling. My focus includes markerless motion capture systems like FreeMoCap and OpenCap, with applications in human locomotion analysis and biomechanical simulation.

Previously, I worked as a Robotics Software Developer Intern at [Black-I Robotics](https://www.blackirobotics.com/){:target="_blank"} where I was advised by [Mr, Gaurav Singh](https://www.linkedin.com/in/gaurav-singh-k47a/){:target="_blank"}, where I developed vision and software systems for robotic arms used in autonomous pick-and-place and mixed-case palletization. I worked across multiple aspects of product development, including large robot arm motion planning, digital twinning, and hardware–software integration, gaining exposure from prototype to production-level systems.

Before that, I was an R&D Intern at [Indrones Solutions](https://indrones.com/){:target="_blank"}, mentored by [Mr. Arvind Pandit](https://avi241.github.io/#aboutme){:target="_blank"} and [Dr. Apurva Joshi](https://zapurva.github.io/){:target="_blank"}. My work included developing kinematic models for mobile robots, implementing SLAM and navigation simulations, teleoperation and joystick-based control for Mecanum-wheeled robots, Intel RealSense camera calibration, and integrating VINS-Mono for visual–inertial navigation.
...
<script type="text/javascript" id="mapmyvisitors" src="//mapmyvisitors.com/map.js?d=Flmla1GmpLtS3uoJQTMTGZmM09VEEoq2ZD6UU4USqO8&cl=ffffff&w=a"></script>

Visit my website statistics at [mapmyvisitors.com](https://mapmyvisitors.com/web/1c2kq)
