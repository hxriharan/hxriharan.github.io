...
In parallel, I am collaborating with [Prof. Bruce Maxwell](https://www.khoury.northeastern.edu/people/bruce-maxwell/){:target="_blank"}, on a project exploring Spectral Ratio Estimation and physics-based computer vision. This work builds on Retinex theory and intrinsic image decomposition, combining classical gradient-based methods with deep learning and geometric cues like depth and surface normals.

Previously, I was an R&D Intern at [Indrones Solutions](https://indrones.com/){:target="_blank"}, where I was mentored by [Mr. Arvind Pandit](https://avi241.github.io/#aboutme){:target="_blank"} and [Dr. Apurva Joshi](https://zapurva.github.io/){:target="_blank"}. My work involved developing kinematic models for mobile robots, performing SLAM and navigation simulations, implementing teleoperation and joystick-based control for Mecanum wheeled robots, calibrating Intel RealSense cameras, and integrating VINS-Mono for visual-inertial navigation.
